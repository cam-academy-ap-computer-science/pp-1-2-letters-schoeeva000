...
public class Letters {
	...
	public static void letter2() {
		System.out.println("Dear cousin Liam,\n");
		common();
	...
	public static void common() {
		System.out.println("I am doing very well. Just yesterday I got back from a retreat,");
		System.out.println("and on that retreat I helped to watch the little kids. In school,");
		System.out.println("I am doing very well,  and so far my grades are great! I have the");
		System.out.println("perfect Christmas present for you, I can't wait to get it!\n");
	}
}
